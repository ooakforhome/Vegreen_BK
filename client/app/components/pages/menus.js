    ...
    return(
      <div>
        <div className="col-12">
          ...
          <div className="col-4">
            <div className="iCol-8">
              <img alt="mag" src={this.state.magzImg} />
            </div>
          </div>
        </div>
        ...
        <div className="menu_box">
          <div className="s-col-6 col-3 menu-thumb"><img alt="menu_01" src="../assets/img/Menu_01.jpg" /><p>MENU 01</p></div>
          <div className="s-col-6 col-3 menu-thumb"><img alt="menu_02" src="../assets/img/Menu_02.jpg" /><p>MENU 02</p></div>
          <div className="s-col-6 col-3 menu-thumb"><img alt="Sushi" src="../assets/img/Sushi_Menu.jpg" /><p>SUSHI MENU</p></div>
          <div className="s-col-6 col-3 menu-thumb"><img alt="Lunch" src="../assets/img/Soft_Lunch.jpg" /><p>LUNCH MENU</p></div>
        </div>
        ...
        <div className="margin-10">
          <div className="s-col-12 col-3"><div className="iCol-8"><img alt="dish-1" src={this.state.dis1} /></div></div>
          <div className="s-col-12 col-3"><div className="iCol-8"><img alt="dish-2" src={this.state.dis2} /></div></div>
          <div className="s-col-12 col-3"><div className="iCol-8"><img alt="dish-3" src={this.state.dis3} /></div></div>
          <div className="s-col-12 col-3"><div className="iCol-8"><img alt="dish-4" src={this.state.dis4} /></div></div>
        </div>
      </div>
    )
  }
